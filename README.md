...
# description of the project
  ...
  player, logic, etc.
  Then I implemented the functions for each entity
...
# challenge 
  ...
  And the outer function executes the function with the arguments sent along with the function that needs to be executed.